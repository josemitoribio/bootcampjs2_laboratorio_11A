...
export const extraerCodigoSucursal = (grupos: any): string => {
    return grupos.codigoSucursal;
}

export const extraerDigitoControl = (grupos: any): string => {
    return grupos.digitoControl;
}

export const extraerNumeroCuenta = (grupos: any): string => {
    return grupos.numeroCuenta;
}
